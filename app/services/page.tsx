...
export const metadata: Metadata = {
  title:
    "Technology Services by Zerro | Leading Tech Solutions from Australia's Fast-Growing Tech Company",
  description: "Zerro offers a wide range of custom software development services in Australia. From app development to IT consulting, we deliver tailored solutions to drive your business success.",
};
